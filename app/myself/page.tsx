        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section>
            ...
            <p className="p-4 bg-blue-100 rounded-lg">
              During my internship at <b>Umicore Belgium,</b> I worked on building a state-of-the-art AI Model to classify patents. This experience enhanced my understanding <br />
            ...
            <p className="p-4 bg-blue-100 rounded-lg">
              When I&apos;m not coding or analyzing data, you&apos;ll find me working on my personal development, from honing my skills to getting a good work-out done for the day.
            </p>
          </section>
